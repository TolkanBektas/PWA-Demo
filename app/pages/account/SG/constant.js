...
export const headerMessages = defineMessages({
    profile: {defaultMessage: 'My Account', id: 'global.account.header.link.account_details'},
    orders: {defaultMessage: 'Check Order', id: 'global.account.header.link.order_history'},
    wishlist: {defaultMessage: 'Wish List', id: 'global.account.link.wishlist'}
})
