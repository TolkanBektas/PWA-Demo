...
// Icons
import {BrandLogo, LocationIcon, UserIconSg} from '../../icons'
        ...
        <Drawer isOpen={isOpen} onClose={onClose} placement="left" size={drawerSize}>
            <DrawerOverlay>
                <DrawerContent>
                    ...
                    {/* Main Content */}
                    <DrawerBody background="nightRider">
                        ...
                        <VStack align="stretch" spacing={0} {...styles.actions} px={0}>
                            <Box {...styles.actionsItem}>
                                <Flex direction={'column'} fontSize="12px">
                                    <Flex color={'white'}>
                                        <UserIconSg boxSize={4} marginRight="0.5rem" fill="white" />
                                        <Text>
